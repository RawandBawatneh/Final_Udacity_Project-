 ...
 */ function navigateTo(pageName) {
    ...
    (0, _utilityRenderFunctionsJs.hideError)(elements.errorMessage);
}
/**
 ...
 */ function initCreateSetForm() {
    elements.createSetForm.addEventListener("submit", (e)=>{
        ...
        if (!(0, _utilityRenderFunctionsJs.validateNotEmpty)(setName)) {
            (0, _utilityRenderFunctionsJs.showError)("Please enter a set name", elements.errorMessage);
            return;
        }
        // Add set to state
        state.sets.push(setName);
        // Re-render sets
        (0, _utilityRenderFunctionsJs.renderSets)(state.sets, elements.setsContainer);
        // Clear form
 ...
 */ function initAddCardForm() {
    elements.addCardForm.addEventListener("submit", (e)=>{
        ...
        if (!(0, _utilityRenderFunctionsJs.validateNotEmpty)(front)) {
            (0, _utilityRenderFunctionsJs.showError)("Please enter a question for the front of the card", elements.errorMessage);
            return;
        }
        if (!(0, _utilityRenderFunctionsJs.validateNotEmpty)(back)) {
            (0, _utilityRenderFunctionsJs.showError)("Please enter an answer for the back of the card", elements.errorMessage);
            return;
        }
        // Add card to state
        state.cards.push({
        ...
        // Re-render cards
        (0, _utilityRenderFunctionsJs.renderCards)(state.cards, elements.cardsContainer);
        // Clear form
 ...
 */ function initShuffle() {
    elements.shuffleButton.addEventListener("click", ()=>{
        if (state.cards.length > 1) {
            state.cards = (0, _shuffleJs.shuffle)(state.cards);
            (0, _utilityRenderFunctionsJs.renderCards)(state.cards, elements.cardsContainer);
        }
    });
}
 ...
 */ var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "renderCard", ()=>renderCard);
/**
 ...
 */ parcelHelpers.export(exports, "renderSetBadge", ()=>renderSetBadge);
/**
 ...
 */ parcelHelpers.export(exports, "renderSets", ()=>renderSets);
/**
...
function renderSetBadge(setName) {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}]},["7wZbQ","2R06K"], "2R06K", "parcelRequireccf0", {})

//# sourceMappingURL=Final_Udacity_Project-.0f77c784.js.map
